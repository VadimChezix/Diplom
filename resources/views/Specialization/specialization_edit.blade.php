                            ...
                            <form action="{{route('specialization_update',$specialization->id)}}" method="POST">
                                ...
                                <div class="row mt-5">
                                    <div class="col">
                                        ...
                                        <input type="text" name="name" class="form-control mt-3" value="{{$specialization->name}}">
                                    </div>
                                ...
                                <div class="row mt-5">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control mt-3" name="url" value="{{$specialization->url}}" placeholder="https://bgpk.edu22.info/абитуриенту/специальности/####-##-##-##">
                                    </div>
                                </div>
                                <div class="row mt-5">
                                    <div class="col d-flex justify-content-center">
